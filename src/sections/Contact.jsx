    ...
    <section ref={ref} id="contact" className="relative section-pad bg-ink-900 py-32 sm:py-40">
      <div className="container-max grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
        <div className="contact-left">
          ...
          <p className="mt-6 max-w-md text-base leading-relaxed text-haze-soft sm:text-lg">
            Fill out the form or reach out directly. We reply to every message personally — usually
          ...
          <ul className="mt-9 flex flex-col gap-3">
            {METHODS.map((m) => (
              <li key={m.label}>
                <a
                  href={m.href}
                  className="focus-ring group flex items-center gap-4 rounded-2xl glass px-5 py-4 transition-all hover:border-royal-light/50 hover:shadow-glow"
                ...
                >
                  ...
                  <span>
                    <span className="meta block text-haze">{m.label}</span>
                    <span className="block font-display text-lg italic text-white">{m.value}</span>
                  </span>
                  <Icon
                    name="arrow"
        ...
        <div className="contact-form rounded-[2rem] glass-strong p-6 shadow-glow sm:p-8">
          {status === 'success' ? (
            <div className="flex h-full min-h-[420px] flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="max-w-sm text-haze-soft">
            ...
            <form onSubmit={onSubmit} className="flex flex-col gap-6" noValidate>
              ...
              {status === 'error' && (
                <p role="alert" className="text-sm text-red-300">
                  ...
                  <a href={SITE.emailHref} className="underline">{SITE.email}</a> directly.
                </p>
              )}
              <Button
                type="submit"
