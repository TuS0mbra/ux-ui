...
const PRINCIPLES = [
  ...
  { icon: 'shield', label: 'One designer, start to finish' },
]
        ...
        <Reveal>
          <div>
            ...
            <h2 className="mt-5 font-display text-3xl font-bold leading-[1.1] tracking-tightest text-white sm:text-4xl lg:text-5xl">
              One designer, obsessed with making your business look{' '}
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-haze">
              <p>
                {/* PLACEHOLDER: rewrite this story in your own voice */}
                S0MBRA Studio is a one-person design house built on a simple belief: a great website
              ...
              <p>
                I work directly with you — no account managers, no outsourced teams, no templates
                dressed up as "custom." Just sharp design, fast code, and an obsession with detail
                that makes the kind of site people screenshot and ask, "who built that?"
              </p>
            </div>
