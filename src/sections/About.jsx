          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-base leading-relaxed text-haze">
              <p>
                ...
                works 24/7, it never calls in sick, and it decides whether a stranger trusts you in
              ...
              <p>
                ...
                friendly, sharp design and fast code that fits the business you actually run — and
                the kind of site people screenshot and ask, "who built that?"
              </p>
            </div>
